...
ON " . $wpdb->prefix . "spidercalendar_event.category=" . $wpdb->prefix . "spidercalendar_event_category.id;");
  ...
  ?>
  <form action="admin.php?page=SpiderCalendar&calendar_id=<?php echo $calendar_id; ?>" method="post" id="adminForm" name="adminForm" enctype="multipart/form-data">
    <table width="95%">
      <tr>
        <td style="width:45%">
          <div style="width:95%">
            <fieldset class="adminform">
              ...
              <table class="admintable">
                <tr>
                 ...
                 <tr>
                  <td class="key"><label for="title">Picture: </label></td>
                  <td><input type="file" id="file" name="file" size="41"/></td>
                </tr>
          ...
          ?>
                ...
                <tr>
                  <td class="key"><label for="published1">Featured: </label></td> 
                  <td>
                    <input type="radio" name="featured" id="featured0" value="0" checked="checked" class="inputbox">
                    <label for="featured0">No</label>
                    <input type="radio" name="featured" id="featured1" value="1" class="inputbox">
...
function html_edit_spider_event($row, $calendar_id, $id, $cal_name) {
  ...
  <form action="admin.php?page=SpiderCalendar&calendar_id=<?php echo $calendar_id; ?>&id=<?php echo $id; ?>" method="post" id="adminForm" name="adminForm" enctype="multipart/form-data">
    <table width="95%">
      <tr>
        <td style="width:45%">
          <div style="width:95%">
            <fieldset class="adminform">
              ...
              <table class="admintable">
                ...
                <tr>
                  <td class="key"><label for="title">Picture: </label> </td>
                  <td><input type="file" id="file" name="file" size="41"/> <div style="float:right; padding-right:10px"><?php if(!empty($row->pic)) { ?> <img height="80" src="<?php echo $row->pic; ?>" /> <?php } ?></div><input type="hidden" name="picurl" value="<?php echo $row->pic; ?>" /></td>
                </tr>
				<tr>
                  <td class="key"><label for="category">Select Category: </label></td>
                  <td>
          ...
          ?>
                ...
                <tr>
                 ...
                 <tr>
                  <td class="key"><label for="published1">Featured: </label></td>
                  <td>
                    <input type="radio" name="featured" id="featured0" value="0" <?php cheched($row->featured, '0'); ?> class="inputbox">
                    <label for="featured0">No</label>
                    <input type="radio" name="featured" id="featured1" value="1" <?php cheched($row->featured, '1'); ?> class="inputbox">
                    <label for="featured1">Yes</label>
                  </td>
                </tr>
                <tr>
